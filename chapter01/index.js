...
Exercises.special1 = function () {
  ...
  // Return the result here: 1-Infinity
  return Infinity;
...
Exercises.special3 = function () {
  ...
  // Return the result here: Infinity-Infinity
  return NaN;
...
Exercises.special4 = function () {
  ...
  // Return the result here: 2/Infinity
  return 0;
...
Exercises.strings1 = function () {
  ...
  return "Return a string enclosed in double quotes." ;
...
Exercises.strings2 = function () {
  ...
  return  'Return a string enclosed in single quotes.';
...
Exercises.strings3 = function () {
  ...
  return 'Return multi-line string\n(a string that includes a new line character).' ;
...
Exercises.strings5 = function () {
  ...
  return "supercalifragilistic"+"expialidocious";
...
// Unary 1
// Use the type of operator to return the type of "Hello, world!"
